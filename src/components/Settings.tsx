...
export function Settings() {
  ...
  const updateEmailPreferences = useMutation(
    api.settings.updateEmailPreferences
  );
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-purple-50 rounded-xl">
            <div>
              ...
              <div className="text-sm text-gray-600">
                Get a fun math problem delivered to your inbox every day
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleEmailPrefsChange("dailyQuestions", e.target.checked)
                }
          ...
          <div className="flex items-center justify-between p-4 bg-pink-50 rounded-xl">
            <div>
              ...
              <div className="text-sm text-gray-600">
                Get a leaderboard summary, the latest math news, and a brief
                explanation of a random math concept
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleEmailPrefsChange("weeklyReports", e.target.checked)
                }
                className="sr-only peer"
              />
          ...
          <div className="flex items-center justify-between p-4 bg-pink-50 rounded-xl">
            <div>
              ...
              <div className="text-sm text-gray-600">
                Get your game results along with personalized tips for
                improvement
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleEmailPrefsChange("gameResults", e.target.checked)
                }
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-pink-600"></div>
